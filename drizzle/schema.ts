import { sqliteTable, AnySQLiteColumn, foreignKey, primaryKey, text, integer, numeric } from "drizzle-orm/sqlite-core"
...
export const goals = sqliteTable("goals", {
	id: numeric("id").primaryKey().notNull(),
	userId: numeric("user_id").notNull().references(() => user.id),
	categoryId: numeric("category_id").notNull().references(() => oldPushCategories.id),
